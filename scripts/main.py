...
parser.add_argument('-sa','--saving_epoch',type=int,required=False,default=10,help='In which epoch to save e.g. 10 means the model would be saved every tenth epoch while training')
