...
parser.add_argument('-i','--inference',type=str,required=False,default='f',help='If this flag is t then the model will run only on test set to store result on hico format')
